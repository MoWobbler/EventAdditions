...
public class CreateObjectiveCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        Location location1 = new Location(cmdBlock.getBlock().getWorld(), x1, y1, z1);
        Location location2 = new Location(cmdBlock.getBlock().getWorld(), x2, y2, z2);
        Team team = Objects.requireNonNull(EventAdditions.instance.getServer().getScoreboardManager()).getMainScoreboard().getTeam(args[7]);
        float secondsToCapture = Long.parseLong(args[8]);
